...
export const siteSettings = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'localizedString',
      group: 'contact',
      description: 'مثال: السبت - الخميس: ٥:٠٠ م - ٨:٠٠ م',
    }),
    defineField({
      name: 'dailyScheduleTitle',
      title: 'Daily Schedule Title / عنوان المواعيد اليومية',
      type: 'localizedString',
      group: 'contact',
      description: 'مثال: المواعيد اليومية / Daily Schedule',
    }),
    defineField({
      name: 'dailyScheduleDays',
      title: 'Daily Schedule Days / أيام التدريب اليومية',
      type: 'localizedString',
      group: 'contact',
      description: 'مثال: من السبت إلى الخميس / Saturday to Thursday',
    }),
    defineField({
      name: 'dailyScheduleHours',
      title: 'Daily Schedule Hours / ساعات التدريب اليومية',
      type: 'localizedString',
      group: 'contact',
      description: 'مثال: من 5 إلى 8م / 5:00 PM – 8:00 PM',
    }),
    defineField({
      name: 'socialLinks',
